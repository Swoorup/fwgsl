  Future plan for multi parameter traits and constrained inference
  ...
  - Revisit specialization/generic codegen. Right now the constrained-top-level rule keeps things manageable, but if shadml grows more generic libraries, specialization and template retention policy will matter
    more.
